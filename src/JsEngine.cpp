...
namespace
{
  v8::Handle<v8::Value> ConsoleErrorCallback(const v8::Arguments& arguments)
  {
  ...
  v8::Handle<v8::ObjectTemplate> CreateConsole(
    AdblockPlus::ErrorCallback& errorCallback)
  {
    ...
    const v8::Handle<v8::FunctionTemplate> errorFunction =
      v8::FunctionTemplate::New(ConsoleErrorCallback,
    ...
    AdblockPlus::ErrorCallback& errorCallback)
  {
    ...
    global->Set(v8::String::New("console"), CreateConsole(errorCallback));
