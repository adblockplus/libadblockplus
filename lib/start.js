...
var Components =
{
  ...
  results: {},
  utils: {
    reportError: LibAdblockPlus.reportError
  },
  manager: null,
  ID: function()
  {
...
var Prefs =
{
  ...
  data_directory: LibAdblockPlus.dataPath,
  savestats: false,
  privateBrowsing: false,
  get subscriptions_autoupdate() { return LibAdblockPlus.autoUpdateSubscriptions; },
...
var Utils =
{
  ...
  addonVersion: LibAdblockPlus.version,
  platformVersion: "10.0",
  get appLocale()
  {
    LibAdblockPlus.locale;
  },
...
FakeFile.prototype =
{
  ...
  exists: function()
  {
    return LibAdblockPlus.fileExists(this.path);
  },
  remove: function()
  {
    LibAdblockPlus.fileRemove(this.path);
  },
  moveTo: function(parent, newPath)
  {
    LibAdblockPlus.fileRename(this.path, newPath);
  },
  get lastModifiedTime()
  {
    return LibAdblockPlus.fileLastModified(this.path);
  },
  get parent()
  {
...
FakeInputStream.prototype =
{
  ...
  init: function(file)
  {
    if (file instanceof FakeInputStream)
      ...
      this.lines = LibAdblockPlus.fileRead(file.path).split(/\n/);
  },
...
FakeOutputStream.prototype =
{
  ...
  close: function()
  {
    LibAdblockPlus.fileWrite(this.file.path, this.buffer.join(""));
  },
  finish: function()
  {
    this.close();
...
function updateSubscriptionStatus(subscription)
{
  ...
  LibAdblockPlus.setStatus(status, time);
}
...
LibAdblockPlus.load("XMLHttpRequest.jsm");
LibAdblockPlus.load("FilterNotifier.jsm");
LibAdblockPlus.load("FilterClasses.jsm");
LibAdblockPlus.load("SubscriptionClasses.jsm");
LibAdblockPlus.load("FilterStorage.jsm");
LibAdblockPlus.load("FilterListener.jsm");
LibAdblockPlus.load("Matcher.jsm");
LibAdblockPlus.load("ElemHide.jsm");
LibAdblockPlus.load("Synchronizer.jsm");

FilterListener.startup();
Synchronizer.startup();

LibAdblockPlus.load("publicSuffixList.js");
LibAdblockPlus.load("punycode.js");
LibAdblockPlus.load("basedomain.js");
